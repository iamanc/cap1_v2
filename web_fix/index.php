...
<body>
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          <li class="active"><a href="index.php?page=accueil.php">Welcome</a></li>
          <li><a href="index.php?page=about.php">Team</a></li>
          <li><a href="index.php?page=services.php">Services</a></li>
          <li><a href="index.php?page=works.php">Works</a></li>
          <li><a href="membres.php?id=2">Member</a></li>
        </ul>
      </div>
      <!--/.nav-collapse -->
    </div>
  ...
  //Ngăn chặn LFI bằng cách thêm điều kiện 
  if (isset($_GET['page']) && in_array($_GET['page'], $pages)) {
  // dùng hàm htmlspecialchars
      echo "<div class='welcome-message'>WELCOME TO " . htmlspecialchars($_GET['page']) . "</div>";
      include($_GET['page']);
    }
    else{
      include("accueil.php");
